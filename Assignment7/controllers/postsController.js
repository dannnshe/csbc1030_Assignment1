const { PostModel } = require("../models/postModel"); // Adjust the import path based on your project structure
...
const postsController = {
  ...
  async createPost(req, res) {
    try {
      const { title, content, userId } = req.body; // Assume these fields are required
